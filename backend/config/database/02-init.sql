...
-- Dodanie plików
INSERT INTO file (user_id, file_name, file_path, size) 
VALUES 
(1, 'file1.txt', '/uploads/file1.txt', 1024),
(1, 'file2.txt', '/uploads/file2.txt', 2048),
(2, 'file3.txt', '/uploads/file3.txt', 512);
